...
if cmp --silent -- goldpolish_target_test_golden_path.targeted.polished.fa goldpolish_target_test_golden_path.targeted.polished.expected.fa && \
   cmp --silent -- goldpolish_target_test_golden_path.targeted.gaps.i.fa goldpolish_target_test_golden_path.targeted.gaps.expected.fa && \
   cmp --silent -- goldpolish_target_test_golden_path.targeted.gaps.goldpolished.i.fa goldpolish_target_test_golden_path.targeted.gaps.goldpolished.expected.fa; then 
